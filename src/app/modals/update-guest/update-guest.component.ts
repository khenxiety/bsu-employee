...
export class UpdateGuestComponent implements OnInit {
  ...
  year3:any=''
  sub_type:any
  constructor(private http: HttpClient,private firestore:Firestore, private toast: ToastrService,private mat:MatDialog,public dialogRef: MatDialogRef<UpdateGuestComponent>,@Inject(MAT_DIALOG_DATA) public data:any) { }
  ...
  const updatedoc=doc(this.firestore,'guest',this.id)
