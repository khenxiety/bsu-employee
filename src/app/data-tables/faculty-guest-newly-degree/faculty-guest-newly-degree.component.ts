...
@Component({
  selector: 'app-faculty-guest-newly-degree',
  templateUrl: './faculty-guest-newly-degree.component.html',
  styleUrls: ['./faculty-guest-newly-degree.component.scss']
})
export class FacultyGuestNewlyDegreeComponent implements AfterViewInit {
  ...
  exportexcel(): void 
    {
      ...
      // remove column
       ...
       /* save to file */
       XLSX.writeFile(wb, 'Faculty List Form C (Guest Lecturer | Newly Hired).xlsx');
       location.reload();
