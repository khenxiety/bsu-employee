...
@Component({
  selector: 'app-faculty-guest-invited-personal',
  templateUrl: './faculty-guest-invited-personal.component.html',
  styleUrls: ['./faculty-guest-invited-personal.component.scss']
})
export class FacultyGuestInvitedPersonalComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    getDocs(
      ...
      this.data=this.data.filter((item: { sub_type: string; })=>item.sub_type=="invited foreign lecturer");
  ...
  exportexcel(): void {
      ...
      let element = document.getElementById('table-invited-personal'); 
      ...
      // remove column
       ...
       /* save to file */
      XLSX.writeFile(wb, 'Faculty List Form B (Guest Lecturer | Invited Foreigner Lecturers).xlsx');
      location.reload();
