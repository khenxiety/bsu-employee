...
@Component({
  selector: 'app-faculty-guest-newly-personal',
  templateUrl: './faculty-guest-newly-personal.component.html',
  styleUrls: ['./faculty-guest-newly-personal.component.scss']
})
export class FacultyGuestNewlyPersonalComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    getDocs(
      ...
      this.data=this.data.filter((item: { sub_type: string; })=>item.sub_type=="newly hired");
  ...
  exportexcel(): void {
      ...
      let element = document.getElementById('table-newly-degree'); 
      ...
      // remove column
       ...
       /* save to file */
      XLSX.writeFile(wb, 'Faculty List Form B (Guest Lecturer | Newly Hired).xlsx');
      location.reload();
