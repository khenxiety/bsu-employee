...
@Component({
  selector: 'app-faculty-guest-invited-degree',
  templateUrl: './faculty-guest-invited-degree.component.html',
  styleUrls: ['./faculty-guest-invited-degree.component.scss']
})
export class FacultyGuestInvitedDegreeComponent implements AfterViewInit {
  ...
  exportexcel(): void 
    {
       ...
       let element = document.getElementById('table-invited-degree'); 
      ...
      // remove column
       ...
       /* save to file */
       XLSX.writeFile(wb, 'Faculty List Form C (Guest Lecturer | Invited Foreigner Lecturers).xlsx');
       location.reload();
